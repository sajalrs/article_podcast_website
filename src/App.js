          ...
          <BrowserRouter>
               <Switch>
                 <Route path="/" exact render={() => {
                  return <Home fitLarge={fitLarge} playVideo={playVideo} getImageLink={getImageLink} getEmbedPlayerLink={getEmbedPlayerLink} getLinkFunction={getLinkFunction}/>
                 }}/>
                  <Route path="/" render={() => {
                    return <div>The page you are trying to find does not exist.</div>
                 }}/>
